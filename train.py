...
parser.add_argument("--milestones", type=int, default=[100, 150], nargs='+', help='Set to epoch values where you want to decrease learning rate by a factor of 0.1. Default: [100, 150]')
